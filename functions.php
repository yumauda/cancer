...
{
	wp_enqueue_style('font', '//fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100;400;700&display=swap', '', "1.0.1");
	wp_enqueue_style('my', get_template_directory_uri() . '/css/styles.css', array(), '1.2.0', 'all');
