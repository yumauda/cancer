...
{
	wp_enqueue_style('font', '//fonts.googleapis.com/css2?family=Montserrat:wght@400;700&family=Noto+Sans+JP:wght@100;400;700&family=Noto+Serif+JP&display=swap', '', "1.0.1");
	wp_enqueue_style('swiper', '//unpkg.com/swiper@8/swiper-bundle.min.css', '', "1.0.1");
	wp_enqueue_style('fullpage', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.5/jquery.fullpage.css', '', "1.0.1");
	...
	wp_enqueue_script('my-scroll', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/vendors/scrolloverflow.min.js', '', "1.0.1", true);
	wp_enqueue_script('my-fullpage', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.5/jquery.fullpage.js', '', "1.0.1", true);
